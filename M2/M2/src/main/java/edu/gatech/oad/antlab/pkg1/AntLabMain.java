 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Yvonne Yeh");
		  toPrint += p1.toString("yyeh35");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Andrew Tuttle");
		  toPrint += p2.toString("atuttle7");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Andrew Ho");
		  toPrint += p3.toString("aho44");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Andrew Le");
                  toPrint += p4.toString("andrew7");
                  //Person5 replace P5 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Alexander Chan");
                  toPrint += p5.toString("achan49");
				  Person6 p6 = new Person6("Max Seo");
				  toPrint += p6.toString("mseo31");
